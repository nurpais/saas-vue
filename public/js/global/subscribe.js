  ...
  $("#subscribeform")
    ...
    .validate({
      ...
      submitHandler: function(form) {
        ...
        $("#js-subscribe-result")
          .fadeIn("slow")
          .html('<p class="help-block">Please wait...</p>');
        ...
        $.ajax({
            ...
            if (d == "success") {
              if (noredirect) {
                $("#js-subscribe-result")
                  .fadeIn("slow")
                  .html(
                    '<p class="help-block text-success">' + success_msg + "</p>"
                  )
                  .delay(3000)
                  .fadeOut("slow");
              } else {
              ...
              $("#js-subscribe-result")
                .fadeIn("slow")
                .html('<p class="help-block text-danger">' + error_msg + "</p>")
                .delay(3000)
                .fadeOut("slow");
              console.log(d);
            }
          ...
          error: function(d) {
            $("#js-subscribe-result")
              .fadeIn("slow")
              .html(
                '<p class="help-block text-danger"> Sorry. Cannot access the PHP Server</p>'
              )
              .delay(3000)
              .fadeOut("slow");
            $("#js-subscribe-btn").attr("disabled", false);
